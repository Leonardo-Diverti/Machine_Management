# Questo file definisce gli endpoint API relativi ai macchinari e ai loro documenti.
...
urlpatterns = [
    ...
    # Documenti amministrativi per il macchinario
