...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # ==========================================
        machines_data = [
            ('CDL-5707', 'CC-5707', 'Taglio', 2018, 'attiva', 'COMPLESSA', 'PLC', '192.168.1.101', 'BTB', 'Macchina laser tubo LT722 Fiber'),
            ('CDL-6720', 'CC-6720', 'Uniko', 2019, 'attiva', 'COMPLESSA', 'PLC', '192.168.1.102', 'BTB', 'Macchina Laser tubo Adige LT722 Fiber'),
            ('CDL-8864', 'CC-8864', 'Pressfitting', 2017, 'attiva', 'COMPLESSA', 'IOX', '192.168.1.103', 'BTB', 'Isola automatizzata di montaggio collaudo e montaggio o-ring'),
            ('CDL-5436', 'CC-5436', 'Carbonio', 2020, 'attiva', 'COMPLESSA', 'RIO', '192.168.1.201', 'BTB', 'Macchina automatica di assemblaggio raccordi FELP - Matr. RM07251'),
            ('CDL-8822', 'CC-8822', 'Pilastro', 2015, 'in_manutenzione', 'COMPLESSA', 'RIO', '192.168.1.202', 'BTB', 'Isola automatizzata di calibratura/smussatura 90° Ø 15-54'),
            ('CDL-8795', 'CC-8795', 'Imballo', 2021, 'attiva', 'ACQUISTO_DIRETTO', 'PLC', '192.168.1.203', 'BTB', 'Centro di lavoro verticale DVF4000 - Matricola: MV0166-000158'),
            ('CDL-2115', 'CC-2115', 'Taglio', 2016, 'attiva', 'COMPLESSA', 'IOX', '192.168.1.301', 'BTB', 'Curvatrice per diametri 15-18-22 e 28'),
            ('CDL-8878', 'CC-8878', 'Uniko', 2022, 'attiva', 'ACQUISTO_DIRETTO', 'PLC', '192.168.1.302', 'BTB', 'CC8142 - Isola robotizzata tornio PUMA TW2600B'),
            ('CDL-5714', 'CC-5714', 'Carbonio', 2014, 'ferma', 'COMPLESSA', 'IOX', '192.168.1.303', 'BTB', 'Macchina di deformazione automatica robotizzata Betty 3'),
            ('CDL-5743', 'CC-5743', 'Carbonio', 2023, 'dismessa', 'COMPLESSA', 'PLC', '192.168.1.401', 'BTB', 'Automazione Deformatrice Curve 90° 15-28 Rame'),
        ]

        for index, (cdl, cc, cap, anno, stato, machine_type, acc, ip, marca, modello) in enumerate(machines_data, 1):
            commessa_data = {
                'commessa': f'ACQ-{anno}-{index:02d}' if machine_type == 'ACQUISTO_DIRETTO' else None,
                'commessa_macchina': f'MAC-{anno}-{index:02d}' if machine_type == 'COMPLESSA' else None,
                'commessa_automazione': f'AUT-{anno}-{index:02d}' if machine_type == 'COMPLESSA' else None,
            }
            machine = Machine.objects.create(
                cdl=cdl, cc=cc, capannone=cap, anno_avviamento=anno,
                tipo_macchina=machine_type, stato=stato, **commessa_data
            )
