...
const API = {
    ...
    async getMachineLocations() {
        return this.request('/machines/locations/');
    },
    ...
    async getMachineChecklist(machineId) {
        return this.request(`/machines/${machineId}/checklist/`);
    },

    async updateChecklistItem(machineId, itemId, data) {
        return this.request(`/machines/${machineId}/checklist/${itemId}/`, {
            method: 'PATCH',
            body: JSON.stringify(data),
        });
    },
    ...
    async getFiscalBenefit(machineId) {
        return this.request(`/machines/${machineId}/benefit_fiscal/`);
    },

    async toggleFiscalBenefit(machineId, value) {
        return this.request(`/machines/${machineId}/benefit_fiscal/`, {
            method: 'POST',
            body: JSON.stringify({ attivo: value }),
        });
    },

    async uploadFiscalBenefitDocument(machineId, formData) {
        return this.request(`/machines/${machineId}/benefit_fiscal_documents/`, {
            method: 'POST',
            body: formData,
        });
    },

    async createFiscalBenefitMaintenance(machineId, formData) {
        return this.request(`/machines/${machineId}/benefit_fiscal_maintenance/`, {
            method: 'POST',
            body: formData,
        });
    },

    async deleteFiscalBenefitDocument(machineId, docId) {
        return this.request(`/machines/${machineId}/benefit_fiscal_documents/${docId}/`, {
            method: 'DELETE',
        });
    },

    async closeFiscalBenefit(machineId) {
        return this.request(`/machines/${machineId}/close_benefit_fiscal/`, {
            method: 'POST',
        });
    },

    // === INTERCONNESSIONE ===
    async getInterconnessione(machineId) {
        return this.request(`/machines/${machineId}/interconnessione/`);
    },

    async updateInterconnessione(machineId, data) {
        return this.request(`/machines/${machineId}/interconnessione/`, {
            method: 'POST',
            body: JSON.stringify(data),
        });
